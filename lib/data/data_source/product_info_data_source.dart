...
List<ProductInfo> dripBagInfo = [
  ...
  ProductInfo(
    ...
    description: '비옥한 화산토, 일정한 일교차, 낮은 습도 등의 기후 조건을 가진 과테말라 안티구아(Antigua) 지역의 커피\n사탕수수, 코코아, 레몬맛의 산미가 특징이며 다크로스트에서 강한 스모크향과 품질 좋은 시가향을 느낄 수 있습니다.',
  ...
  ProductInfo(
    ...
    description: 'Narino 소농들이 재배하여 picking과 processing이 뛰어난 원두\n사탕수수의 단맛과 건포도의 달콤한 맛과 감귤맛을 느낄 수 있습니다.',
    cupNote: '감귤 건포도 사탕수수',
    price: '13,500',
  ),
  ProductInfo(
